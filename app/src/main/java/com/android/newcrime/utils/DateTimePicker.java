...
public class DateTimePicker extends RelativeLayout implements View.OnClickListener, DatePicker.OnDateChangedListener, TimePicker.OnTimeChangedListener {
    ...
    public DateTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDatePickerView = (LinearLayout) inflater.inflate(R.layout.datepicker, null);
        mTimePickerView = (LinearLayout) inflater.inflate(R.layout.timepicker, null);
        ...
        // Init date picker
        datePicker = (DatePicker) mDatePickerView.findViewById(R.id.DatePicker);
        datePicker.init(mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH), mCalendar.get(Calendar.DAY_OF_MONTH), this);
        datePicker.setCalendarViewShown(false);

        // Init time picker
        timePicker = (TimePicker) mTimePickerView.findViewById(R.id.TimePicker);
        ...
        viewSwitcher.addView(mDatePickerView, 0);
        viewSwitcher.addView(mTimePickerView, 1);
    }
    // Constructor end
    ...
    public void clickTime(){
        findViewById(R.id.SwitchToDate).setVisibility(GONE);
        onClick(findViewById(R.id.SwitchToTime));
        mDatePickerView.setVisibility(GONE);
    }

    public void clickDate(){
        findViewById(R.id.SwitchToTime).setVisibility(GONE);
        onClick(findViewById(R.id.SwitchToDate));
        mTimePickerView.setVisibility(GONE);
        mDatePickerView.setVisibility(VISIBLE);
    }
